	...
	return (
		<div id="CollapsibleHeader-topHeader" className="CollapsibleHeader-topHeader">
			<div id="CurrentConditionsAtAGlanceDetail">
				    ...
				    <span id="weather-icon" className="weather-icon" style={{backgroundImage: "url('https://raw.githubusercontent.com/fabianalexisinostroza/Antu-classic/90645fdd27cb53ddd77476dedcf8698488c903a9/Antu/status/64/weather-few-clouds.svg')"}} />
